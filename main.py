...
from tgbot.utils.misc_functions import (check_bot_data, startup_notify, update_profit_day,
...
async def scheduler_start(rSession):
    ...
    scheduler.add_job(update_profit_week, trigger="cron",
                      day_of_week="mon", hour=00, minute=1)
...
async def on_startup(dp: Dispatcher):
    ...
    print(colorama.Fore.LIGHTBLUE_EX + "~~~~~ HighThai Growing ~~~~~")
